...
fighter_wight, fighter_height = fighter_image.get_size()
fighter_x, fighter_y = screen_width / 2 - fighter_wight / 2, screen_height - fighter_height
...
rocket_x, rocket_y = fighter_x + fighter_wight / 2 - rocket_wight / 2, fighter_y - rocket_height
...
while game_is_running:
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            ...
            if event.key == pygame.K_SPACE:
                ...
                rocket_x = fighter_x + fighter_wight / 2 - rocket_wight / 2
    ...
    if fighter_is_moving_right and fighter_x <= screen_width - fighter_wight - FIGHTER_STEP:
        fighter_x += FIGHTER_STEP
